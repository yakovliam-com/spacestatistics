...
public class Message {
    ...
    /**
     * Sends a message to a com.yakovliam.minehutcore.command sender
     *
     * @param commandSender com.yakovliam.minehutcore.command sender
     * @param replacers     replacers
     */
     ...
     *
     * @param commandSenders com.yakovliam.minehutcore.command senders 'list'
     * @param replacers      replacers
     */

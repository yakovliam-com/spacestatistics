package com.yakovliam.spacestatistics.api.config.generic;

import com.yakovliam.spacestatistics.api.config.util.ImmutableCollectors;
import com.yakovliam.spacestatistics.api.config.generic.adapter.ConfigurationAdapter;
import com.yakovliam.spacestatistics.api.config.generic.key.ConfigKey;
import com.yakovliam.spacestatistics.api.config.generic.key.SimpleConfigKey;

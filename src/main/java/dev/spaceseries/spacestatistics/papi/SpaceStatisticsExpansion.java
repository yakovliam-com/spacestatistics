...
public class SpaceStatisticsExpansion extends PlaceholderExpansion {
     ...
     * Construct expansion
     */
    public SpaceStatisticsExpansion() {
    ...
    public @NotNull String getAuthor() {
        return String.join(", ", SpaceStatistics.getInstance().getDescription().getAuthors());
    }
    ...
    public @NotNull String getVersion() {
        return SpaceStatistics.getInstance().getDescription().getVersion();
    }
